...
class MultiHeadedAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None):
        ...
        # x ~ (30, 8, 10, 64) -> transpose(1,2) ->(30, 10, 8, 64) -> contiguous() and view ->(30, 10, 8*64) = (30, 10, 512)
        return self.linears[-1](x)
        # 执行第四个Linear network，把(30, 10, 512)经过一次linear network，得到(30, 10, 512).
