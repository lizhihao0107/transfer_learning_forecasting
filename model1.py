...
class TransformerModel(nn.Module):
    def __init__(self, input_dim, model_dim, num_heads, num_layers, output_dim, max_len=5000):
        ...
        self_attn=transformer.MultiHeadedAttention(num_heads,model_dim)
        feed_forward=transformer.PositionwiseFeedForward(model_dim,model_dim*4)
        encoder_layer = transformer.EncoderLayer(model_dim,self_attn,feed_forward)
        self.transformer_encoder = transformer.Encoder(encoder_layer,num_layers)
